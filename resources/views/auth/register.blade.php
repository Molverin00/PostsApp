    ...
    <div class="flex justify-center">
        <div class="w-8/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="POST">
                @csrf <!-- Cross Site Request Forgery protection (hidden security token) -->
                <div class="mb-4">
                    ...
                    @error('name')
                        <div class="text-red-500 mt-23 text-sm">
                            {{ $message }}
                        </div>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password" id="password" placeholder="Password" class="bg-gray-100 border-2 w-full p-4 rounded-lg" value="{{ old('name') }}">
